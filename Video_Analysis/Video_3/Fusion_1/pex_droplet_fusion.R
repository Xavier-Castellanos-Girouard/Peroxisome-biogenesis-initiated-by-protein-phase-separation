...
aspect_ratio$major_axis = as.numeric(major_axis_raw[1,10:60])
...
time_slice_end = which(aspect_ratio$time == 1.5)
...
# Plot decay functio
plot(eDecay(t = (analysis_slice_df$time), IniAR = initial_aspect_ratio, 0.07686))
...
fit_model1 <- 
  nls(values ~ eDecay(time, initial_aspect_ratio, tau), 
      ...
      start = list(tau = 0.07686))

print(fit_model1) # 0.07686
