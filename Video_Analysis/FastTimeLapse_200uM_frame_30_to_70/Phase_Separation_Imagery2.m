...
%% Importing data
directory = "/home/xavier/Desktop/Phase_Separation/FastTimeLapse_200uM_frame_30_to_70/"; % Specify path to tiff file
fileName = "FastTimeLapse_200uM_frame_30_to_70.tif"; % Specify file name 
...
%disp(AR0);
%%
writematrix(ratios,'aspect_ratio_values_faster.csv') 

%%
writematrix(axis_major,'axis_major_values_faster.csv')
